...
namespace PlatformCMS.Controllers
{
    ...
    public class ProductPriceInLocationController : ControllerBase
    {
        ...
        ProductBranchBCL branchBCL;
        ProductVersionByBranchBCL ProductVersionBCL;
        public ProductPriceInLocationController()
        {
            ...
            branchBCL = new ProductBranchBCL();
            ProductVersionBCL = new ProductVersionByBranchBCL();
        }
        ...
        [HttpGet("GetBrachByLocationID")]
        public ResponseData GetBrachByLocationID(int LocationID)
        {
            ResponseData responseData = new ResponseData();
            try
            {
                var brachs = branchBCL.FindAll(x => x.LocationID == LocationID);

                responseData.Success = true;
                responseData.Message = "Thành công";
                responseData.Data = brachs;
            }
            catch (Exception ex)
            {
        ...
        [HttpGet("GetProductByBranchID")]
        public ResponseData GetProductByBranchID(int BranchID)
        {
            ResponseData responseData = new ResponseData();
            try
            {
                var brachs = ProductVersionBCL.FindAll(x => x.ProductBranchID == BranchID);
                responseData.Success = true;
                responseData.Message = "Thành công";
                responseData.Data = brachs;
            }
        ...
        [HttpPost("AddProducVersion")]
        public ResponseData AddProducVersion([FromBody] ProductVersionInBranch obj)
        {
            ResponseData responseData = new ResponseData();
            try
            {
                bool result = ProductVersionBCL.Add(obj.IDBranch, obj.ProductVersionByBranches);
                if (result)
                {
                    responseData.Success = true;
                    responseData.Message = "Thành công";
