...
namespace PlatformCMS.Controllers
{
    ...
    public class DepartmentController : ControllerBase
    {
        ...
        public ResponseData GetByLocationId(int LocationId)
        {
            ResponseData responseData = new ResponseData();
            try
            {
                var ads = departmentBCL.FindAll(x => x.LocationId == LocationId);
                if (ads != null)
                {
                    responseData.Success = true;
                    responseData.Message = Utility.SuccessMessage;
                    responseData.ListData = ads.ToList<object>();
                }
            }
            catch (Exception ex)
            {
