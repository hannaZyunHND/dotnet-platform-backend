...
const Subscriber = () => import('./../pages/subscriber/list');
    ...
    routes: [
        {
            ...
            children: [
                ...
                {
                    path: '/admin/productrenewal/list',
                    name: 'Thu cũ đổi mới',
                    component: ProductRenewal,
                    meta: { authorize: [] }
                },
                {
                    path: '/admin/productComponent/list',
                    name: 'Danh sách linh kiện sản phẩm',
                    component: ProductComponent,
                    meta: { authorize: [] }

                },
                {
                    path: '/admin/productComponent/add',
                    name: 'Thêm mới link kiện',
