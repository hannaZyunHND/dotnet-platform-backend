                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="col-md-12">
                                            <b-form-group label="Tên đầy đủ">
                                                <b-form-input v-model="objRequest.fullName" placeholder="Tên đầy đủ"></b-form-input>
                                            </b-form-group>
                                        </div>
                                        <div class="col-md-12">
        ...
        methods: {
            ...
            async GetById() {
                ...
                if (this.objRequest.avatar) {
                    this.preview = "/uploads/" + this.objRequest.avatar;
                }
                    ...
                    if (response.success == true) {
                        reader.onload = (e) => {
                            if (response.data[0].path != '/') {
                                this.objRequest.avatar = response.data[0].path;
                                this.preview = e.target.result;
                            }
                            else
                                this.$toast.error(response.data[0].messages, {});
                        };
