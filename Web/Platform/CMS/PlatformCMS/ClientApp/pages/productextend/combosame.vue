                                            ...
                                            <ul style="padding:20px;padding-left:10px ;width:100%">
                                                <li v-for="(item,index) in ListValue" @click="changeValueRight(index)" :class="{'active':item.active}">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-4">
                                                            <p style="display:none"><input type="number" v-model="item.configPrice" placeholder="Giá giảm" /></p>
                                                            <p style="display:none"><input type="text" v-model="item.configNote" placeholder="Ghi chú" /></p>
                                                        </div>
                                                    </div>
