                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="qr-image-container">
                                    <qrcode-vue :value="order.code" :size="qrSize" level="H"></qrcode-vue>
                                </div>
                            </div>
                            <!--<div class="col-md-4">
                                <div class="table-responsive">
                                    <div class="dataTables_wrapper dt-bootstrap4 no-footer">
                                        ...
                                        <table class="table table-bordered table-mini-text table-style-custom no-margin">
                                            <tbody>
                                                <tr role="row" class="odd">
                                                    <td colspan="2"><b>Thông tin trả góp</b></td>
                                                </tr>
                                                <tr role="row" class="odd">
                                                    <td>Ngân hàng</td>
                                                    <td>{{order.installmentDetail.nganHang}}</td>
                                                </tr>
                                                <tr role="row" class="odd">
                                                    <td>Số tháng trả góp</td>
                                                    <td>{{order.installmentDetail.soThangTraGop}}</td>
                                                </tr>
                                                <tr role="row" class="odd">
                                                    <td>Trả trước</td>
                                                    <td>{{order.installmentDetail.traTruoc}}</td>
                                                </tr>
                                                <tr role="row" class="odd">
                                                    <td>Trả góp mỗi tháng</td>
                                                    <td>{{order.installmentDetail.traGopMoiThang}}</td>
                                                </tr>
                                                <tr role="row" class="odd">
                                                    <td>Tổng số tiền</td>
                                                    <td>{{order.installmentDetail.tongSoTien}}</td>
                                                </tr>
                                                <tr role="row" class="odd">
                                                    <td>Chênh lệch</td>
                                                    <td>{{order.installmentDetail.chenhLech}}</td>
                                                </tr>
                                        ...
                                        <table class="table table-bordered table-mini-text table-style-custom no-margin">
                                            ...
                                            <tbody>
                                                <tr role="row" class="odd" v-for="(item,index) in order.odderDetail">
                                                    ...
                                                    <td v-html="item.activeStatus"></td>
                                                    <td>{{(item.oderPrice)}}</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
