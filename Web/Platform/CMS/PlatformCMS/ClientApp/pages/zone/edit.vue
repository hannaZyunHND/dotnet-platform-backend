                    ...
                    <div class="col-sm-6 col-md-8">
                        <b-card class="mt-3" header="Thông tin danh mục">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <b-form-group label="Danh mục cha">
                                        <treeselect :multiple="false" :options="ZoneByType"
                                            placeholder="Xin mời bạn lựa chọn danh mục" v-model="objRequest.parentId"
                                    ...
                                    <a @click="openImg('bg')">
                                        <div style="width:50%;display:flex" class="gallery-upload-file ui-sortable">
                                            <div style="width:100%;display:flex;margin:0"
                                                ...
                                                <div style="width:100%"
                                                    v-if="objRequest.background != null && objRequest.background != undefined && objRequest.background.length > 0">
                                                    <img alt="Ảnh lỗi" style="height:100px;width:100%"
                                                        :src="pathImgs(objRequest.background)"
                                                        class="preview-image img-thumbnail-full">
                                                </div>
                                                <div v-else>
                                    ...
                                    <a @click="openImg('banner')">
                                        <div style="width:50%;display:flex" class="gallery-upload-file ui-sortable">
                                            <div style="width:100%;display:flex;margin:0"
                                                class=" r-queue-item ui-sortable-handle">
                                                <div style="width:100%"
                                                    v-if="objRequest.banner != null && objRequest.banner != undefined && objRequest.banner.length > 0">
                                                    <img alt="Ảnh lỗi" style="height:100px;width:100%"
                                                        :src="pathImgs(objRequest.banner)"
                                                        class="preview-image img-thumbnail-full">
                                                </div>
                                                <div v-else>
                                                    <i class="fa fa-picture-o"></i>
                            ...
                            <b-form-group label="Tùy chọn lọc giá">
                                <b-form-input v-model="objRequest.fillter"
                                    placeholder="Tạo bộ lọc giá theo định dạng : 0-10000,10000-1000000...."
                                    required></b-form-input>
                            </b-form-group>
                            <b-form-group label="Nhà cung cấp">
                                <treeselect :multiple="true" :options="Manufacturer"
                                    placeholder="Xin mời bạn lựa chọn nhãn hiệu" v-model="objRequest.manufacturerIds"
                                    :default-expanded-level="Infinity" />
                            </b-form-group>
                        </b-card>
                    </div>
                    <div class="col-sm-6 col-md-4">
                        ...
                        <b-card header="Cấu hình">
                            ...
                            <b-form-group label="Thứ tự">
                                <b-form-input v-model="objRequest.sortOrder" placeholder="Thứ tự"
                                    required></b-form-input>
                            </b-form-group>
                            ...
                            <b-form-group label="Loại note (Chỉ dành cho danh mục Booking Note)">
                                ...
                                <small style="color:red">(* Lưu ý: Chuyển sang vùng ngôn ngữ để cập nhật placeholder và
                                    các lựa chọn nếu có)</small>
                            </b-form-group>
                                    ...
                                    <a @click="openImg('icon')">
                                        <div style="width:80px;height:80px;display:flex"
                                            ...
                                            <div style="width:100%;height:100%;display:flex;margin:0"
                                                class=" r-queue-item ui-sortable-handle">
                                                <div style="width:100%"
                                                    v-if="objRequest.icon != null && objRequest.icon != undefined && objRequest.icon.length > 0">
                                                    <img alt="Ảnh lỗi" style="height:100%;width:100%"
                                                        :src="pathImgs(objRequest.icon)"
                                                        class="preview-image img-thumbnail-full">
                                                </div>
                                                <div v-else>
                                                    <i class="fa fa-picture-o"></i>
                    ...
                    <div class="col-sm-6 col-md-8">
                        <b-card class="mt-3" header="Thông tin danh mục">
                            ...
                            <b-form-group label="Tên theo ngôn ngữ">
                                <b-form-input v-model="objRequestLanguage.name" placeholder="Tên danh mục"
                                    v-on:keyup.13="slugM()" required></b-form-input>
                            </b-form-group>
                            <b-form-group label="Đường dẫn">
                                <b-form-input v-model="objRequestLanguage.url" placeholder="Đường dẫn"
                                    required></b-form-input>
                            </b-form-group>
                            <b-form-group label="Đường dẫn cũ">
                                <b-form-input v-model="objRequestLanguage.urlOld" placeholder="Đường dẫn cũ"
                                    required></b-form-input>
                            </b-form-group>
                            <div class="row">
                                <div class="col-md-6">
                                    <b-form-group label="Breadcrumb thay thế">
                                        <b-form-input v-model="objRequestLanguage.breadcrumbFirst"
                                            placeholder="Dùng để thay thế text breadcrumb" required></b-form-input>
                                    </b-form-group>
                                </div>
                                <div class="col-md-6">
                                    <b-form-group label="Url Breadcrumb thay thế">
                                        <b-form-input v-model="objRequestLanguage.breadcrumUrl"
                                            placeholder="Dùng để thay thế url breadcrumb" required></b-form-input>
                                    </b-form-group>
                                </div>
                            </div>

                            <b-form-group label="Mô tả">
                                <ckeditor tag-name="textarea" v-model="objRequestLanguage.description"
                                    :config="editorConfig">
                                </ckeditor>
                            </b-form-group>
                            <b-form-group label="Nội dung">
                                <b-form-group label="Nội dung">
                                    <MIEditor :contentEditor="objRequestLanguage.content"
                                        v-on:handleEditorInput="getOrSetData"></MIEditor>
                                </b-form-group>
                            </b-form-group>

                            <b-form-group label="Banner Link">
                                <b-form-input v-model="objRequestLanguage.bannerLink"
                                    placeholder="Đường dẫn khi kích vào BannerLink" required></b-form-input>
                            </b-form-group>
                            <b-form-group label="Note placeholder">
                                <b-form-input v-model="objRequestLanguage.notePlaceHolder"
                                    placeholder="Place holder của ô nhập note" required></b-form-input>
                            </b-form-group>
                            <b-form-group label="Danh sách lựa chọn Note">
                                <b-form-input v-model="objRequestLanguage.noteOptions"
                                    placeholder="Đường dẫn khi kích vào BannerLink" required></b-form-input>
                                <small style="color:red">(* Các lựa chọn được phân cách nhau bởi dấu ,)</small>
                            </b-form-group>
                            <b-form-group label="Mùa du lịch phổ biến">
                                <b-form-input v-model="objRequestLanguage.suggestionSeason"
                                    placeholder="Mùa du lịch phổ biến" required></b-form-input>
                            </b-form-group>
                            <b-form-group label="Thời gian phù hợp để du lịch">
                                <b-form-input v-model="objRequestLanguage.suggestionTraveldDate"
                                    placeholder="Thời gian phù hợp để du lịch" required></b-form-input>
                            </b-form-group>
                        </b-card>
                        <div class="card">
                            <div class="card-header">
                                Comment
                                <b-btn v-b-toggle.collapseComment variant="primary" class="pull-right"><i
                                    ...
                                    <div class="row">
                                        <div class="col-3">
                                            <button class="btn btn-primary"
                                                @click="onClickAddExtraProperty(comments)">Thêm</button>
                                        </div>

                                        <div class="row" v-for="(c, index) in comments">
                                            <div class="col-12">
                                                <b-form-group label="Tiêu đề">
                                                    <b-form-input v-model="c.title"></b-form-input>
                                                </b-form-group>
                                                <b-form-group label="Nội dung">
                                                ...
                                                <b-form-group>
                                                    <button class="btn btn-danger"
                                                        @click="onClickRemoveExtraProperty(c, index)">Xoá</button>
                                                </b-form-group>
                                            </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                Faq
                                <b-btn v-b-toggle.collapseFaq variant="primary" class="pull-right"><i
                                        class="fa fa-angle-double-down" aria-hidden="true"></i></b-btn>

                            </div>
                            <b-collapse id="collapseFaq" class="mt-2">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-3">
                                            <button class="btn btn-primary"
                                                @click="onClickAddExtraProperty(faqs)">Thêm</button>
                                        </div>

                                        <div class="row" v-for="(c, index) in faqs">
                                            <div class="col-12">
                                                <b-form-group label="Tiêu đề">
                                                    <b-form-input v-model="c.title"></b-form-input>
                                                </b-form-group>
                                                <b-form-group label="Nội dung">
                                                    <MIEditor :contentEditor="c.description"
                                                        v-on:handleEditorInput="getOrSetDataVersionFaq" :index="index">
                                                    </MIEditor>
                                                </b-form-group>
                                                <b-form-group>
                                                    <button class="btn btn-danger"
                        ...
                        <div class="card">
                            <div class="card-header">
                                Tag tìm kiếm
                                <b-btn v-b-toggle.collapseSearchTag variant="primary" class="pull-right"><i
                                        class="fa fa-angle-double-down" aria-hidden="true"></i></b-btn>

                            </div>
                            <b-collapse id="collapseSearchTag" class="mt-2">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-3">
                                            <button class="btn btn-primary"
                                                @click="onClickAddExtraProperty(searchTags)">Thêm</button>
                                        </div>
                                    </div>
                                    <div class="row" v-for="(c, index) in searchTags">
                                        <div class="col-12">
                                            <b-form-group label="Tiêu đề">
                                                <b-form-input v-model="c.title"></b-form-input>
                                            </b-form-group>
                                            <b-form-group label="Nội dung">
                                                <b-form-textarea v-model="c.description" placeholder="Danh sách search"
                        ...
                        <div class="card">
                            <div class="card-header">
                                SEO Analysis
                                <b-btn v-b-toggle.collapseSEO variant="primary" class="pull-right"><i
                                        class="fa fa-angle-double-down" aria-hidden="true"></i></b-btn>
                            ...
                            <b-collapse id="collapseSEO" class="mt-2">
                                <div class="card-body">
                                    <b-form-group label="Tiêu đề SEO">
                                        <b-form-input v-model="objRequestLanguage.metaTitle" placeholder="Tiêu đề SEO"
                                            required></b-form-input>
                                    </b-form-group>
                                    <b-form-group label="Từ khóa SEO">
                                        <b-form-input v-model="objRequestLanguage.metaKeyword" placeholder="Từ khóa SEO"
                                            required></b-form-input>
                                    </b-form-group>
                                    <b-form-group label="Mô tả">
                                        <b-form-textarea v-model="objRequestLanguage.metaDescription"
                                            placeholder="Mô tả" rows="3" max-rows="6" required></b-form-textarea>
                                    </b-form-group>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <b-form-checkbox placeholder="Canonical" v-model="statusCanonical"
                                                    required>Chặn trùng lặp nội dung (Canonical)</b-form-checkbox>
                                            </div>
                                            <div class="col-md-6">
                                                <b-form-checkbox placeholder="NoIndex" v-model="statusNoindex"
                                                    required>Chặn lập chỉ mục (NoIndex)</b-form-checkbox>
                                            </div>
                                        </div>
                                    </b-form-group>
...
export default {
    ...
    methods: {
        ...
        getOrSetDataVersionFaq(value) {
            //////console.log(value)
            var dt = JSON.parse(value);
            ////console.log(dt)
            this.faqs[dt.index].description = dt.content;
        },
        onClickAddExtraProperty(object) {
        ...
        DoAddEditLang() {
            ...
            this.objRequestLanguage.comments = JSON.stringify(this.comments);
            this.objRequestLanguage.faqs = JSON.stringify(this.faqs);
            this.objRequestLanguage.searchTags = JSON.stringify(this.searchTags);
            // console.log(this.objRequestLanguage);
