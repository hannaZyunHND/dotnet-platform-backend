                        ...
                        <b-form class="form-horizontal">
                            ...
                            <b-row>
                                ...
                                <div class="col-md-3 col-sm-9">
                                    <b-form-group label="Danh sách kỳ hạn (Ví dụ: 3,6,12,24....)">
                                        <b-form-input v-model="objRequest.period" placeholder="Danh sách kỳ hạn" required></b-form-input>
                                    </b-form-group>
                                </div>
...
import debounce from "../../services/debounce";
    ...
    export default {
        ...
        methods: {
            ...
            pathImgs(path) {
                let url = 'http://cms.didongxanh.com.vn/' + "uploads" + path;
                return url;
            },
            MonthNumberChange() {
