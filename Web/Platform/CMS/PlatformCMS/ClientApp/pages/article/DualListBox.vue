    ...
    <div class="list-box-wrapper">
        <div class="list-box-item">
            ...
            <div class="bulk-action">
                <div class="select-all" @click="selectAllSource">Chọn tất cả</div>
                <div class="deselect-all" @click="deSelectAllSource">Xoá chọn</div>
            </div>
        </div>
        <div class="actions">
        ...
        <div class="list-box-item">
            <div class="search-box">
                <input v-model="searchDestination" type="text" placeholder="Tìm kiếm"/>
                <div
            ...
            <div class="bulk-action">
                <div class="select-all" @click="selectAllDestination">Chọn tất cả</div>
                <div class="deselect-all" @click="deSelectAllDestination">Xoá chọn</div>
            </div>
        </div>
    </div>
</template>
