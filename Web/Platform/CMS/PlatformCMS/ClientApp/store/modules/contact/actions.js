...
const getProductRenewOld = ({ commit }, data) => {
    return HttpService.post(`/api/ProductOldRenewal/GetAllOldRenewalCustomer`, data).then(response => {
        return response.data;
    }).catch(e => {
        alert('ex found:' + e)
    })
}
const updateStatusProductOldRenewal = ({ commit }, data) => {
    return HttpService.put(`/api/ProductOldRenewal/UpdateStatus`, data).then(response => {
        return response.data;
    }).catch(e => {
        alert('ex found:' + e)
    })
