    ...
    <div class="card card-data">
        <div class="card-body">
            <table :class="tableClasses"
                   class="table data-thumb-view dataTable no-footer" 
                   style="border-collapse: collapse;">
                <!-- TABLE HEADER -->
                <thead class="thead-dark table table-centered table-nowrap">
                    <tr :class="headerRowClasses">
                        <vue-ads-header-cell v-for="(column, key) in nonGroupedColumns"
                                             :key="key"
                                             :column="column"
                                             :column-index="key"
                ...
                <tbody>
                    ...
                    <template v-else
                        ...
                        <vue-ads-row v-if="!row._meta.groupColumn"
                                     :key="rowKey"
                                     :row="row"
                                     :row-index="rowKey"
