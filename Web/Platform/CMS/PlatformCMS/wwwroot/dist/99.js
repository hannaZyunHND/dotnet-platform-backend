...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("(* Lưu ý: Chuyển sang vùng ngôn ngữ để cập nhật placeholder và các lựa chọn nếu có)")])])], 1), _vm._v(" "), _c('b-card', {
    attrs: {
      "header": "Hình ảnh"
    }
  }, [_c('b-form-group', {
  ...
  }, [_vm._v("(* Các lựa chọn được phân cách nhau bởi dấu ,)")])], 1)], 1), _vm._v(" "), _c('div', {
    staticClass: "card"
  }, [_c('div', {
...
Component.options.__file = "C:\\WORKING\\Joytime\\dotnet-platform-backend\\Web\\Platform\\CMS\\PlatformCMS\\ClientApp\\pages\\zone\\edit.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
