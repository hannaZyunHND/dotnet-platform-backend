...
exports.default = {
    ...
    methods: (0, _extends3.default)({}, (0, _vuex.mapActions)(["getFlashSales", "createFlashSale", "removeFlashSale", "updateStatusFlashSale", "deleteFlashsales"]), {
        format_date: function format_date(value) {
            if (value) {
                return (0, _moment2.default)(String(value)).format('DD/MM/YYYY HH:mm');
            }
        },
        deleteFlashsale: function deleteFlashsale() {
            var _this = this;

            console.log(this.ListFlashsale);
            this.deleteFlashsales({ ids: this.ListFlashsale }).then(function (response) {
                if (response) _this.onChangePaging();
            });
        },
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }), _vm._v(" Thêm mới")]), _vm._v(" "), _c('button', {
  ...
  }, [_vm._m(0), _vm._v(" "), _c('tbody', _vm._l((_vm.objRequests.listData), function(item, index) {
    return _c('tr', {
      staticClass: "odd",
      attrs: {
        "role": "row"
      ...
      model: {
        value: (_vm.ListFlashsale),
        callback: function($$v) {
          _vm.ListFlashsale = $$v
        },
        expression: "ListFlashsale"
      }
    })], 1), _vm._v(" "), _c('td', {
...
if (true) {
  module.hot.accept()
  if (module.hot.data) {
     __webpack_require__(178).rerender("data-v-301ddf61", module.exports)
  }
}
...
Component.options.__file = "C:\\WORKING\\Joytime\\dotnet-platform-backend\\Web\\Platform\\CMS\\PlatformCMS\\ClientApp\\pages\\flashsale\\list.vue"
...
if (true) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-301ddf61", Component.options)
  } else {
    hotAPI.reload("data-v-301ddf61", Component.options)
  }
})()}
