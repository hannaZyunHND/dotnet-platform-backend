...
var _manufacturerRepository = __webpack_require__(1019);

var _manufacturerRepository2 = _interopRequireDefault(_manufacturerRepository);

var _productSpecificationTemplateRepository = __webpack_require__(1022);
...
exports.default = {
                ...
                while (1) {
                    switch (_context.prev = _context.next) {
                        ...
                        case 2:
                            ...
                            _this.getZones(8).then(function (response) {
                                var data = response.listData;

                                _this.ListDiscountZones = (0, _helper.unflatten)(data);
                                console.log(_this.ListDiscountZones);
                            });
                            _this.GetById();
    ...
    watch: {},
    methods: (0, _extends3.default)({}, (0, _vuex.mapActions)(["addCoupon", "updateCoupon", "getCouponById", "uploadFile", "getProductInCoupon", "addProductInCoupon", "getZones"]), {
                    ...
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            ...
                            case 8:
                                ...
                                _this4.objRequest.activationZoneList = _this4.objRequest.activationZoneList.split(',');
                    ...
                    while (1) {
                        switch (_context3.prev = _context3.next) {
                            case 0:
                                ...
                                _this5.objRequest.activationZoneList = _this5.objRequest.activationZoneList.toString();

                                console.log(_this5.objRequest);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    attrs: {
      "multiple": true,
      "flat": true,
      "options": _vm.ListDiscountZones,
      "placeholder": "Xin mời bạn lựa chọn tag",
      "default-expanded-level": Infinity
    },
    model: {
      value: (_vm.objRequest.activationZoneList),
      callback: function($$v) {
        _vm.$set(_vm.objRequest, "activationZoneList", $$v)
      },
      expression: "objRequest.activationZoneList"
    }
  })], 1)], 1), _vm._v(" "), _c('div', {
    staticClass: "col-md-12"
  }, [_c('b-form-group', {
    attrs: {
      "label": "Mã sử dụng nhiều lần"
    }
  }, [_c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.objRequest.isRepeating),
      expression: "objRequest.isRepeating"
    }],
    attrs: {
      "type": "checkbox",
      "value": "isRepeating"
    ...
    domProps: {
      "checked": Array.isArray(_vm.objRequest.isRepeating) ? _vm._i(_vm.objRequest.isRepeating, "isRepeating") > -1 : (_vm.objRequest.isRepeating)
    },
    on: {
      "change": function($event) {
        var $$a = _vm.objRequest.isRepeating,
          $$el = $event.target,
        ...
        if (Array.isArray($$a)) {
          var $$v = "isRepeating",
            $$i = _vm._i($$a, $$v);
          if ($$el.checked) {
            $$i < 0 && (_vm.$set(_vm.objRequest, "isRepeating", $$a.concat([$$v])))
          } else {
            $$i > -1 && (_vm.$set(_vm.objRequest, "isRepeating", $$a.slice(0, $$i).concat($$a.slice($$i + 1))))
          }
        } else {
          _vm.$set(_vm.objRequest, "isRepeating", $$c)
        }
      }
    }
  })])], 1)])])], 1)], 1), _vm._v(" "), _c('div', {
...
if (true) {
  module.hot.accept()
  if (module.hot.data) {
     __webpack_require__(178).rerender("data-v-1c9b73f8", module.exports)
  }
}
...
var update = __webpack_require__(797)("83618bae", content, false);
...
Component.options.__file = "C:\\WORKING\\Joytime\\dotnet-platform-backend\\Web\\Platform\\CMS\\PlatformCMS\\ClientApp\\pages\\coupon\\edit.vue"
...
if (true) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-1c9b73f8", Component.options)
  } else {
    hotAPI.reload("data-v-1c9b73f8", Component.options)
  }
})()}
