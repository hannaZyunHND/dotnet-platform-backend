...
(function($){
   var Tikslus360 = function(element, options)
   {
       var view360 = $(element);
		...
		var defaults = {
                imageDir:'images',
                imageArrayPicture:'1.jpg,2.jpg,3.jpg,4.jpg,5.jpg,6.jpg,7.jpg,8.jpg,9.jpg,10.jpg',
...
var img_Array=new Array();
 ...
 var modulus=0;
  ...
  var imageArrayPic = options.imageArrayPicture.split(",");
...
for(var i=1;i<imageArrayPic.length;i++){
    debugger
img_Array[i]=new Image();

img_Array[i].src=options.imageDir +'/'+ imageArrayPic[i-1];
clear();
