...
{
    public class ItemProductv4ViewComponent : ViewComponent
    {
        ...
        public ItemProductv4ViewComponent(IZoneRepository zoneRepository, IProductRepository productRepository, IArticleRepository articleRepository)
        {
            _zoneRepository = zoneRepository;
            _productRepository = productRepository;
            _articleRepository = articleRepository;
        }
        public IViewComponentResult Invoke(ProductMinify pr, bool isLazy = true, bool isPayOff = true, bool isH4 = true)
        {
            if (pr != null)
            {
