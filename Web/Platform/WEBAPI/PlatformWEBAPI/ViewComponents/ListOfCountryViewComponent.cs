...
{
    public class ListOfCountryViewComponent : ViewComponent
    {
        ...
        public ListOfCountryViewComponent(IZoneRepository zoneRepository, IProductRepository productRepository, IArticleRepository articleRepository)
        {
