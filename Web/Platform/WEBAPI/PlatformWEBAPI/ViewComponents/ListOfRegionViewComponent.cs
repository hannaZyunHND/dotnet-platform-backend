...
{
    public class ListOfRegionViewComponent : ViewComponent
    {
        ...
        public ListOfRegionViewComponent(IZoneRepository zoneRepository, IProductRepository productRepository, IArticleRepository articleRepository)
        {
