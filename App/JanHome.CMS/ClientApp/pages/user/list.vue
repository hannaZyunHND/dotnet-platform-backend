    ...
    <div class="list-data">
        ...
        <b-card>
            ...
            <div class="table-responsive">
                <table class="table data-thumb-view dataTable no-footer table-centered table-nowrap">
                        ...
                        <tr v-for="item in this.items">
                            ...
                            <td class="text-center">
                                <router-link :to="{path: 'edit/'+item.id}" v-if="item.name!='Admin'">
                                    <span v-b-tooltip.hover title="Sửa người dùng">
                                        <i style="color:gold" class="fa fa-edit"></i>
                                    </span>
                                </router-link>
                                <router-link :to="{path: 'assignRole/'+item.id}" v-if="item.name!='Admin'">
                                    <span  v-b-tooltip.hover title="Thêm nhóm người dùng">
                                        <i style="color:green" class="fa fa-users"></i>
                                    </span>
                                </router-link>
                                <a  v-b-tooltip.hover title="Khóa người dùng"
...
<script>
    ...
    const fields = [
        { key: "User", label: "Tên tài khoản", sortable: true },
    ...
    export default {
        ...
        methods: {
            ...mapActions(["getPageUser", "lockUser"]),
            async onChangePaging() {
                this.isLoading = true;
                let initial = this.$route.query.initial;
                initial = typeof initial != "undefined" ? initial.toLowerCase() : "";
                this.listUser = await this.getPageUser({
                    initial: initial,
                ...
                this.totalRow = this.listUser.totalRow;
                this.items = this.listUser.items;
