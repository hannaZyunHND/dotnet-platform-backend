                ...
                <div role="toolbar" class="mb-2" aria-label="Toolbar with button groups and dropdown menu">
                    ...
                    <div class="mx-1 btn-group mi-paging">
                        <b-pagination v-model="currentPage"
                                      ...
                                      :per-page="pageSize"
                                      aria-controls="_tag"></b-pagination>
                    </div>
                </div>
                <table class="table">
                    ...
                    <tbody>
                        <tr v-for="item in tags.ListData">
...
<script>
    ...
    const fields = [
        ...
        { key: "Url", label: "URL" },
        { key: "Invisibled", label: "Tàng hình" },
        { key: "IsHotTag", label: "Hot Tag", sortable: true },
        { key: "Type", label: "Loại" },
